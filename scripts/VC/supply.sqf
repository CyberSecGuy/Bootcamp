...
{
	// SUPPLIES
     	case "Supply1": {_supply1 = "R3F_WeaponBox" createVehicle (getMarkerPos "Supplyspawn");
     ...
     [-1, {HQ sideChat format _this}, ["%1 has created Field Supplies",name player]] call CBA_fnc_globalExecute; };
     	...
     	case "Supply2": {_supply2 = "R3F_WeaponBox" createVehicle (getMarkerPos "Supplyspawn");
     [_supply2] exec "scripts\VC\Supplies\Medical.sqf";_supply1 allowdamage false;
     ...
     [-1, {HQ sideChat format _this}, ["%1 has created Medical Supplies",name player]] call CBA_fnc_globalExecute; };
     	...
     	case "Supply3": {_supply3 = "R3F_WeaponBox" createVehicle (getMarkerPos "Supplyspawn");
     [_supply3] exec "scripts\VC\Supplies\Recon.sqf";_supply1 allowdamage false;
 	...
 	case "Supply4": {_supply4 = "R3F_WeaponBox" createVehicle (getMarkerPos "Supplyspawn");
 	[_supply4] exec "scripts\VC\Supplies\EOD.sqf";_supply1 allowdamage false;
     ...
     case "Supply5": {_supply5 = "R3F_WeaponBox" createVehicle (getMarkerPos "Supplyspawn");
     [_supply5] exec "scripts\VC\Supplies\AV.sqf";_supply1 allowdamage false;
