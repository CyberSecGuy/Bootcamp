...
if (BTC_active_lift == 1) then
{
	...
	BTC_def_hud       = 1;
	BTC_def_pip       = 1;
	BTC_l_def_veh_pip = ["B_Heli_Light_01_F","O_Heli_Light_02_F","B_mas_mar_Heli_Transport_01_F","I_Heli_Transport_02_F","I_Heli_Transport_03_F","I_Heli_Transport_03_unarmed_F"];
	...
	BTC_get_liftable_array =
	{
		...
		{
			//MH9
			case "B_Heli_Light_01_F"     : {_array = ["Motorcycle","R3F_WeaponBox","Box_IND_AmmoVeh_F","Quadbike_01_base_F","Strategic"];};
			//MVV
			case "O_Heli_Light_02_F"     : {_array = ["Motorcycle","R3F_WeaponBox","Box_IND_AmmoVeh_F","Strategic","StaticWeapon","Car","Truck","Wheeled_APC","Tracked_APC","APC_Tracked_01_base_F","APC_Tracked_02_base_F","Air","Ship"];};
			//UH80
			case "I_Heli_Transport_02_F" : {_array = ["Motorcycle","R3F_WeaponBox","Box_IND_AmmoVeh_F","Strategic","StaticWeapon","Car","Truck","Air","Ship"];};
			//CH49
			case "I_Heli_Transport_02_F" : {_array = ["Motorcycle","R3F_WeaponBox","Box_IND_AmmoVeh_F","Strategic","StaticWeapon","Car","Truck","Wheeled_APC","Tracked_APC","APC_Tracked_01_base_F","APC_Tracked_02_base_F","Air","Ship"];};
		};
		_array
	};
};
if (BTC_active_fast_rope == 1) then
{
	...
	BTC_roping_chopper = ["B_Heli_Light_01_F","O_Heli_Light_02_F","B_Heli_Transport_01_F","I_Heli_Transport_02_F","I_Heli_Transport_03_F","I_Heli_Transport_03_unarmed_F"];
...
if (BTC_active_cargo == 1) then
{
	...
	BTC_def_cargo        = ["R3F_WeaponBox","Box_IND_AmmoVeh_F"];
	BTC_def_drag         = ["R3F_WeaponBox","Box_IND_AmmoVeh_F"];
	BTC_def_placement    = ["Box_IND_AmmoVeh_F"];
